...
- __Deploy__: a web-app at [dinhanhthi.github.io/mountain-vs-beach](https://dinhanhthi.github.io/mountain-vs-beach/) using TensorFlow.js.
...
5. __Deployment__:
    ...
    1. __Chosen approach__ (serverless): using [TensorFlow.js](https://www.tensorflow.org/js) to load weights + trained model from `.json` and `.bin` files + static site + hosted using [Github Pages](https://pages.github.com/) (free).
